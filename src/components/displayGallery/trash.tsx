            ...
            <div className="absolute flex justify-center items-center top-0 left-0 w-full h-screen bg-[rgba(241,245,249,0.4)] trash z-[2]">
                <div className="w-10/12 h-[120px] bg-white rounded-xl md:w-7/12">
                    ...
                    <div className="text-center mt-5 text-black">
                        <button className="bg-transparent shadow-none w-[auto] mx-5" onClick={()=>{removes(props.id,"gallery",props.soceity);props.popOff()}}><FiCheck className="inline text-2xl mx-auto font-thin stroke-[1.5]"/></button>
